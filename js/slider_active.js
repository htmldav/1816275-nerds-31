...
const sliderControlsButtons = document.getElementsByClassName(
  sliderControlsButtonsClass
)[0];
...
sliderControls.addEventListener("click", function (evt) {
  ...
  let curentElement =
    sliderControlsButtons.getElementsByClassName(currentClassName)[0];
  curentElement.classList.remove(currentClassName);

  let newCurentElement = sliderControlsButtons.getElementsByClassName(
    newCurentElementClassName
  )[0];
  newCurentElement.classList.add(currentClassName);

  let featuresListCurrentElement = featuresList.getElementsByClassName(
    newCurentElementClassName
  )[0];

  featuresList
    .getElementsByClassName(slideCurrentClassName)[0]
    .classList.remove(slideCurrentClassName);
